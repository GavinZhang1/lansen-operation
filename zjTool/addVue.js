    ...
    fs.exists(filePath, function (exist) {
      ...
      if (config.action) {
        ...
        config.action.forEach(function (act, itemIndex) {
          data += '\t'.repeat(3) + '<div class="table_action" @click="$router.push({name:\''+ moduleName +'_edit\'})">\n' +
          ...
          var actionMenu = {
            "修改": {
              ...
              "onClick":'\t'.repeat(9) + "on: {\n" +
                ...
                '\t'.repeat(12) + "name:\'"+ moduleName +"_edit\',\n" +
                '\t'.repeat(12) + "params:{\n" +
                '\t'.repeat(13) + 'id:params\n' +
                '\t'.repeat(12) + "}\n" +
                '\t'.repeat(11) + "})\n" +
...
[
  {
    'fileName': 'base_info/product_type.vue',
    'config': {
      filterList: [
        {
          type: 'input',
  ...
  {
    'fileName': 'base_info/process_manage.vue',
    'config': {
      filterList: [
        {
          type: 'input',
